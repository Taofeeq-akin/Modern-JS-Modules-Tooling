...
var addToCart = function addToCart(product, quantity) {
  ...
  console.log("".concat(quantity, " ").concat(product, " is added to Cart"));
};

exports.addToCart = addToCart;
var totalPrice = 210;
exports.totalPrice = totalPrice;
var totalQuantity = 20;
...
console.log(ShoppingCart.totalPrice, ShoppingCart.tq); // We can also import all module ppt in this way

// start the import name to make it like an objeact
ShoppingCart.addToCart('Yam', 13);
console.log(ShoppingCart.totalPrice);
(0, ShoppingCart.default)('Apple', 10);
/*
...
var stateDeepClone = (0, _cloneDeep.default)(state); // can now use this cus we install loadash already
